...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimGraphNode_OptitrackSkeleton_Statics::NewProp_Node = { "Node", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UAnimGraphNode_OptitrackSkeleton, Node), Z_Construct_UScriptStruct_FAnimNode_OptitrackSkeleton, METADATA_PARAMS(Z_Construct_UClass_UAnimGraphNode_OptitrackSkeleton_Statics::NewProp_Node_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_OptitrackSkeleton_Statics::NewProp_Node_MetaData)) }; // 2703219211
	...
	struct Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnetEditor_Public_AnimGraphNode_OptitrackSkeleton_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnetEditor_Public_AnimGraphNode_OptitrackSkeleton_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimGraphNode_OptitrackSkeleton, UAnimGraphNode_OptitrackSkeleton::StaticClass, TEXT("UAnimGraphNode_OptitrackSkeleton"), &Z_Registration_Info_UClass_UAnimGraphNode_OptitrackSkeleton, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimGraphNode_OptitrackSkeleton), 3873992595U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnetEditor_Public_AnimGraphNode_OptitrackSkeleton_h_3520729881(TEXT("/Script/OptitrackNatnetEditor"),
		Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnetEditor_Public_AnimGraphNode_OptitrackSkeleton_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnetEditor_Public_AnimGraphNode_OptitrackSkeleton_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
