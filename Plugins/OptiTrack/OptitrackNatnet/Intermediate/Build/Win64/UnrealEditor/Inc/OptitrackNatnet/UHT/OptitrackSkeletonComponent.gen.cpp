...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_SourceSkeletonAssetName = { "SourceSkeletonAssetName", nullptr, (EPropertyFlags)0x0010000000000025, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOptitrackSkeletonComponent, SourceSkeletonAssetName), METADATA_PARAMS(Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_SourceSkeletonAssetName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_SourceSkeletonAssetName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_StreamingClientOrigin = { "StreamingClientOrigin", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOptitrackSkeletonComponent, StreamingClientOrigin), Z_Construct_UClass_AOptitrackClientOrigin_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_StreamingClientOrigin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_StreamingClientOrigin_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_HideOnInvalidDefinition = { "HideOnInvalidDefinition", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UOptitrackSkeletonComponent), &Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_HideOnInvalidDefinition_SetBit, METADATA_PARAMS(Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_HideOnInvalidDefinition_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_HideOnInvalidDefinition_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_OptitrackAnimInstance = { "OptitrackAnimInstance", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOptitrackSkeletonComponent, OptitrackAnimInstance), Z_Construct_UClass_UOptitrackAnimInstance_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_OptitrackAnimInstance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::NewProp_OptitrackAnimInstance_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackSkeletonComponent_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackSkeletonComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackSkeletonComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptitrackSkeletonComponent, UOptitrackSkeletonComponent::StaticClass, TEXT("UOptitrackSkeletonComponent"), &Z_Registration_Info_UClass_UOptitrackSkeletonComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptitrackSkeletonComponent), 1557237548U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackSkeletonComponent_h_699883982(TEXT("/Script/OptitrackNatnet"),
		Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackSkeletonComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackSkeletonComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
