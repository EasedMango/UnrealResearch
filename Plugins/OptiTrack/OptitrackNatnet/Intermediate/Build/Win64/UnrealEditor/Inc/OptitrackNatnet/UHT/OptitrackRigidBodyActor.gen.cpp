...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AOptitrackRigidBodyActor_Statics::NewProp_bHideOnInvalidDefinition = { "bHideOnInvalidDefinition", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(AOptitrackRigidBodyActor), &Z_Construct_UClass_AOptitrackRigidBodyActor_Statics::NewProp_bHideOnInvalidDefinition_SetBit, METADATA_PARAMS(Z_Construct_UClass_AOptitrackRigidBodyActor_Statics::NewProp_bHideOnInvalidDefinition_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AOptitrackRigidBodyActor_Statics::NewProp_bHideOnInvalidDefinition_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AOptitrackRigidBodyActor_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AOptitrackRigidBodyActor_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AOptitrackRigidBodyActor_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackRigidBodyActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackRigidBodyActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AOptitrackRigidBodyActor, AOptitrackRigidBodyActor::StaticClass, TEXT("AOptitrackRigidBodyActor"), &Z_Registration_Info_UClass_AOptitrackRigidBodyActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOptitrackRigidBodyActor), 3080574101U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackRigidBodyActor_h_2644339475(TEXT("/Script/OptitrackNatnet"),
		Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackRigidBodyActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackRigidBodyActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
