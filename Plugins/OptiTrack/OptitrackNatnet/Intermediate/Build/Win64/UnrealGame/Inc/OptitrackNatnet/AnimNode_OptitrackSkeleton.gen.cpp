...
template<> OPTITRACKNATNET_API UScriptStruct* StaticStruct<FAnimNode_OptitrackSkeleton>()
{
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Public_AnimNode_OptitrackSkeleton_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Public_AnimNode_OptitrackSkeleton_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Public_AnimNode_OptitrackSkeleton_h_2482576206(TEXT("/Script/OptitrackNatnet"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Public_AnimNode_OptitrackSkeleton_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Public_AnimNode_OptitrackSkeleton_h_Statics::ScriptStructInfo),
		nullptr, 0);
