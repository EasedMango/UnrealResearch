...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_StreamingId = { "StreamingId", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOptitrackRigidBodyComponent, StreamingId), METADATA_PARAMS(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_StreamingId_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_StreamingId_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_bDisableLowLatencyUpdate = { "bDisableLowLatencyUpdate", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(uint8), sizeof(UOptitrackRigidBodyComponent), &Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_bDisableLowLatencyUpdate_SetBit, METADATA_PARAMS(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_bDisableLowLatencyUpdate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_bDisableLowLatencyUpdate_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_bNetworkCompensation = { "bNetworkCompensation", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UOptitrackRigidBodyComponent), &Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_bNetworkCompensation_SetBit, METADATA_PARAMS(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_bNetworkCompensation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_bNetworkCompensation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_TrackingOrigin = { "TrackingOrigin", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOptitrackRigidBodyComponent, TrackingOrigin), Z_Construct_UClass_AOptitrackClientOrigin_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_TrackingOrigin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_TrackingOrigin_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_RespectParentTransform = { "RespectParentTransform", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UOptitrackRigidBodyComponent), &Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_RespectParentTransform_SetBit, METADATA_PARAMS(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_RespectParentTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::NewProp_RespectParentTransform_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackRigidBodyComponent_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackRigidBodyComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackRigidBodyComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptitrackRigidBodyComponent, UOptitrackRigidBodyComponent::StaticClass, TEXT("UOptitrackRigidBodyComponent"), &Z_Registration_Info_UClass_UOptitrackRigidBodyComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptitrackRigidBodyComponent), 3261072313U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackRigidBodyComponent_h_379773699(TEXT("/Script/OptitrackNatnet"),
		Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackRigidBodyComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackRigidBodyComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
