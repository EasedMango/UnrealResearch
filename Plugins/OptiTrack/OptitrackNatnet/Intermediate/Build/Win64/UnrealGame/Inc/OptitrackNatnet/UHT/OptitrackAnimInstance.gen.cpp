...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UOptitrackAnimInstance_Statics::NewProp_SourceSkeletonAssetName = { "SourceSkeletonAssetName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOptitrackAnimInstance, SourceSkeletonAssetName), METADATA_PARAMS(Z_Construct_UClass_UOptitrackAnimInstance_Statics::NewProp_SourceSkeletonAssetName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackAnimInstance_Statics::NewProp_SourceSkeletonAssetName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UOptitrackAnimInstance_Statics::NewProp_StreamingClientOrigin = { "StreamingClientOrigin", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOptitrackAnimInstance, StreamingClientOrigin), Z_Construct_UClass_AOptitrackClientOrigin_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UOptitrackAnimInstance_Statics::NewProp_StreamingClientOrigin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackAnimInstance_Statics::NewProp_StreamingClientOrigin_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOptitrackAnimInstance_Statics::ClassParams = {
		...
		0,
		0x009000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UOptitrackAnimInstance_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackAnimInstance_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackAnimInstance_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackAnimInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptitrackAnimInstance, UOptitrackAnimInstance::StaticClass, TEXT("UOptitrackAnimInstance"), &Z_Registration_Info_UClass_UOptitrackAnimInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptitrackAnimInstance), 806975647U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackAnimInstance_h_1639778627(TEXT("/Script/OptitrackNatnet"),
		Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackAnimInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_plugin_OptitrackNatnet_HostProject_Plugins_OptitrackNatnet_Source_OptitrackNatnet_Classes_OptitrackAnimInstance_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
