...
// End Cross Module References
	...
	static UEnum* EOptitrackLiveLinkBoneNamingConvention_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EOptitrackLiveLinkBoneNamingConvention.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OptitrackLiveLink_EOptitrackLiveLinkBoneNamingConvention, Z_Construct_UPackage__Script_OptitrackLiveLink(), TEXT("EOptitrackLiveLinkBoneNamingConvention"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OptitrackLiveLink_EOptitrackLiveLinkBoneNamingConvention_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_OptitrackLiveLink_EOptitrackLiveLinkBoneNamingConvention_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OptitrackLiveLink_EOptitrackLiveLinkBoneNamingConvention_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UE_plugin_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSource_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSource_h_Statics::EnumInfo[] = {
		{ EOptitrackLiveLinkBoneNamingConvention_StaticEnum, TEXT("EOptitrackLiveLinkBoneNamingConvention"), &Z_Registration_Info_UEnum_EOptitrackLiveLinkBoneNamingConvention, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3671044760U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSource_h_3244526716(TEXT("/Script/OptitrackLiveLink"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UE_plugin_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSource_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_plugin_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSource_h_Statics::EnumInfo));
