...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSourceFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSourceFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkNatNetSourceFactory, ULiveLinkNatNetSourceFactory::StaticClass, TEXT("ULiveLinkNatNetSourceFactory"), &Z_Registration_Info_UClass_ULiveLinkNatNetSourceFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkNatNetSourceFactory), 2035305324U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSourceFactory_h_578052746(TEXT("/Script/OptitrackLiveLink"),
		Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSourceFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSourceFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
