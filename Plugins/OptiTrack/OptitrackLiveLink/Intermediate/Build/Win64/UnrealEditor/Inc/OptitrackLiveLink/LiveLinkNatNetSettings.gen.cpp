...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOptitrackLiveLinkSourceSettings_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOptitrackLiveLinkSourceSettings, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UOptitrackLiveLinkSourceSettings_Statics::NewProp_Location_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackLiveLinkSourceSettings_Statics::NewProp_Location_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UOptitrackLiveLinkSourceSettings_Statics::NewProp_SubjectName = { "SubjectName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOptitrackLiveLinkSourceSettings, SubjectName), METADATA_PARAMS(Z_Construct_UClass_UOptitrackLiveLinkSourceSettings_Statics::NewProp_SubjectName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOptitrackLiveLinkSourceSettings_Statics::NewProp_SubjectName_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSettings_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSettings_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSettings_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSettings_h_2873230394(TEXT("/Script/OptitrackLiveLink"),
		Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSettings_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealResearch_Plugins_OptiTrack_OptitrackLiveLink_Source_OptitrackLiveLink_Public_LiveLinkNatNetSettings_h_Statics::EnumInfo));
