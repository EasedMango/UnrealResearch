...
// End Cross Module References
	...
	static UEnum* OptiTrackBoneID_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_OptiTrackBoneID.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OptitrackLiveLink_OptiTrackBoneID, Z_Construct_UPackage__Script_OptitrackLiveLink(), TEXT("OptiTrackBoneID"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OptitrackLiveLink_OptiTrackBoneID_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_OptitrackLiveLink_OptiTrackBoneID_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OptitrackLiveLink_OptiTrackBoneID_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UE_plugin_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_RetargetSkeleton_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_RetargetSkeleton_h_Statics::EnumInfo[] = {
		{ OptiTrackBoneID_StaticEnum, TEXT("OptiTrackBoneID"), &Z_Registration_Info_UEnum_OptiTrackBoneID, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2385793214U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_plugin_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_RetargetSkeleton_h_630415024(TEXT("/Script/OptitrackLiveLink"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UE_plugin_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_RetargetSkeleton_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_plugin_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_RetargetSkeleton_h_Statics::EnumInfo));
